...
namespace HandPumpDefaults
{
	...
	static constexpr float DEFAULT_LOW_WATER_THRES					= 0.5f;			//默认低水域阈值0.5f
	static constexpr float MIN_WATER_FOR_PERAIR						= 10.0f;		//最小修复水量
...
public:	
	...
	float CurrentWater = HandPumpDefaults::DEFAULT_CURR_ENT_WATER;
	//水箱最大水量
	...
	int32 RepairAttempts = HandPumpDefaults::PEP_AIR_ATTEMPTS;
